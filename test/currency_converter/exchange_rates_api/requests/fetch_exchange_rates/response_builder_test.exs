defmodule CurrencyConverter.ExchangeRatesApi.Requests.FetchExchangeRates.ResponseBuilderTest do
  use ExUnit.Case, async: true

  alias CurrencyConverter.ExchangeRatesApi.Requests.FetchExchangeRates.ResponseBuilder
