defmodule CurrencyConverter.ExternalServices.ElasticSearchApi.ResponseHandlerTest do
  use ExUnit.Case, async: true

  alias CurrencyConverter.Error
  alias CurrencyConverter.ExternalServices.ElasticSearchApi.ResponseHandler
