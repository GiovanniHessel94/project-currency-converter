defmodule CurrencyConverter.ExternalServices.ElasticSearchApi.Requests.LogRequests.BodyBuilderTest do
  use ExUnit.Case, async: true

  alias CurrencyConverter.ExternalServices.ElasticSearchApi.Requests.LogRequests.BodyBuilder
