defmodule CurrencyConverter.ExternalServices.ExchangeRatesApi.ResponseHandlerTest do
  use ExUnit.Case, async: true

  alias CurrencyConverter.Error
  alias CurrencyConverter.ExternalServices.ExchangeRatesApi.ResponseHandler
