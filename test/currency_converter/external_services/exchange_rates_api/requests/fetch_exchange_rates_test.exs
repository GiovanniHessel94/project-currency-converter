defmodule CurrencyConverter.ExternalServices.ExchangeRatesApi.Requests.FetchExchangeRatesTest do
  use CurrencyConverter.DataCase, async: true

  import CurrencyConverter.Factory
  import Mox

  alias CurrencyConverter.{Conversion, Error, ExternalServices, TestUtils}

  alias ExternalServices.{
    ElasticSearchApi.ClientMock,
    ExchangeRatesApi.Requests.FetchExchangeRates
  }
